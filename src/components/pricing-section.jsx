      ...
      <div className="container">
        ...
        <div className="bottom_item">
          <div className="pricing_card">
            ...
            <span className="mb-30 price">
              {" "}
              <sup className="sup">$</sup>0<sub>/mo</sub>{" "}
            </span>
            <center>
              <button className="mb-30 price_btn">Start free trial</button>
            </center>
            <ul>
              <li>
                <i className="fa-regular price_point_active fa-circle-check" />{" "}
                Cras justo odio.
              </li>
              <li>
                <i className="fa-regular price_point_active fa-circle-check" />{" "}
              ...
              <li>
                <i className="fa-regular fa-circle-check" /> Morbi leo risus.
              </li>
              <li>
                <i className="fa-regular fa-circle-check" /> Excepteur sint
                occaecat velit.
              </li>
            </ul>
          </div>
